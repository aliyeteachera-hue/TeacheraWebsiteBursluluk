...
import svgPaths from "./svg-sl8be85b92";
import imgHeroImage from "figma:asset/89ef971508b1ec5dd3c5a9f5fff8716e68b2f98e.webp";
import { imgFooterIconContainer } from "./svg-37r5d";
...
export default function EgitimlerFransizca() {
  return (
    <div className="bg-white relative size-full" data-name="Eğitimler_Fransızca">
      ...
      <div className="absolute content-stretch flex items-center justify-center left-[calc(33.33%+112px)] py-[6px] top-[110px]" data-name="Language Button">
        <div aria-hidden="true" className="absolute border-b border-black border-solid inset-0 pointer-events-none" />
        <p className="font-['Neutraface_2_Text:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[16px] text-black">FRANSIZCA</p>
      </div>
      ...
      <div className="absolute font-['Neutraface_2_Text:Book',sans-serif] leading-[24px] left-[calc(20.83%-150px)] not-italic text-[#09090f] text-[16px] top-[497px] w-[449px] whitespace-pre-wrap">
        <p className="mb-0">%100 Fransızca eğitimler, optimize edilmiş ders planları ve Teachera Teaching Method ile yeni bir dili konuşmanın keyfini çıkar.</p>
        <p className="mb-0">&nbsp;</p>
        <p>
          . %100 Fransızca eğitimlerle konuşma, okuma, yazma ve dinleme becerilerini geliştir.
      ...
      <p className="absolute font-['Neutraface_2_Text:Demi',sans-serif] leading-[24px] left-[150px] not-italic text-[#09090f] text-[20px] top-[463px] w-[449px] whitespace-pre-wrap">{`Tüm seviyeler için Fransızca dil becerilerini geliştir. `}</p>
      ...
      <div className="absolute font-['Neutraface_2_Text:Bold',sans-serif] leading-[40px] left-[calc(25%-210px)] not-italic text-[#09090f] text-[32px] top-[353px] w-[473px] whitespace-pre-wrap">
        <p className="mb-0">FRANSIZCA,</p>
        <p>STİLİN VE ZERAFETİN DİLİ</p>
      </div>
