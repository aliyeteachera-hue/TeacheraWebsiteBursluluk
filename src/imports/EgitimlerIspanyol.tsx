...
import svgPaths from "./svg-xqohy57r2s";
import imgHeroImage from "figma:asset/178a022f540eedb11161761adeb6f9c4b34926e2.webp";
import { imgFooterIconContainer } from "./svg-vq8ld";
...
export default function EgitimlerIspanyol() {
  return (
    <div className="bg-white relative size-full" data-name="Eğitimler_İSPANYOL">
      ...
      <div className="absolute font-['Neutraface_2_Text:Book',sans-serif] leading-[24px] left-[calc(20.83%-150px)] not-italic text-[#09090f] text-[16px] top-[531px] w-[449px] whitespace-pre-wrap">
        <p className="mb-0">Teachera Teaching Method ile %100 İspanyolca derslerde konuşma, okuma, yazma ve dinleme yeteneklerinizi doğal şekilde ilerletin.</p>
        <p>
          <br aria-hidden="true" />. Seviyenize uygun ders planlarıyla hedeflerinize ulaşın.
          <br aria-hidden="true" />. Birebir veya grup ders seçenekleri arasından size en uygun olanı seçin.
          <br aria-hidden="true" />. Konuşarak öğrenmenin en etkili yolunu keşfedin ve İspanyolcayı keyifle öğrenin.
        </p>
      </div>
      <p className="absolute font-['Neutraface_2_Text:Demi',sans-serif] leading-[24px] left-[150px] not-italic text-[#09090f] text-[20px] top-[463px] w-[449px] whitespace-pre-wrap">Tüm seviyelere uygun olarak, anadili İspanyolca olan eğitmenlerimiz eşliğinde dil becerilerinizi geliştirin.</p>
      ...
      <p className="absolute font-['Neutraface_2_Text:Bold',sans-serif] leading-[40px] left-[calc(20.83%-150px)] not-italic text-[#09090f] text-[32px] top-[353px] w-[449px] whitespace-pre-wrap">İSPANYOLCA ÖĞRENMENİN EN ETKİLİ YOLU</p>
...
21:30"
      ...
      <div className="absolute content-stretch flex items-center justify-center left-[150px] py-[6px] top-[185px]" data-name="Course Title">
        <p className="font-['Neutraface_2_Text:Book',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#484848] text-[16px]">Çocuklar İçin İspanyolca</p>
      </div>
