...
import svgPaths from "./svg-10hvqvb80j";
import imgHeroImage from "figma:asset/5b326c98ea8ca6d79f2916a4f1a52df791f7ec76.webp";
import { imgFooterIconContainer } from "./svg-kdbna";
...
export default function EgitimlerIngilizceIsIngilizcesi() {
  return (
    <div className="bg-white relative size-full" data-name="Eğitimler_İNGİLİZCE_İş İngilizcesi">
      ...
      <div className="absolute content-stretch flex items-center justify-center left-[calc(25%+95px)] py-[6px] top-[185px]" data-name="Language Button">
        <div aria-hidden="true" className="absolute border-[#09090f] border-b border-solid inset-0 pointer-events-none" />
        <p className="font-['Neutraface_2_Text:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#09090f] text-[16px]">İş İngilizcesi</p>
      </div>
      <Text text="Akademik İngilizce" additionalClassNames="left-[calc(33.33%+88px)]" />
      <Text text="Genel İngilizce" additionalClassNames="left-[150px]" />
      ...
      <LanguageButtonText text="İTALYANCA" additionalClassNames="left-[calc(50%+92px)]" />
      ...
      <div className="absolute contents left-[150px] not-italic text-[#09090f] top-[353px] whitespace-pre-wrap">
        <p className="absolute font-['Neutraface_2_Text:Book',sans-serif] leading-[24px] left-[calc(20.83%-150px)] text-[16px] top-[609px] w-[424px]">B1 seviyesinin üzerindeki katılımcılar için hazırlanan bu eğitimler, %100 İngilizce içeriklerle konuşma, dinleme, okuma ve yazma becerilerini geliştirirken, sektörünüze özel planlarla profesyonel dil hakimiyeti kazandırır. Birebir ders seçeneği ve konuşarak öğrenme temelli yaklaşımıyla, kariyer hedeflerinize hızlı ve kalıcı adımlarla ulaşın.</p>
        <p className="absolute font-['Neutraface_2_Text:Demi',sans-serif] leading-[24px] left-[150px] text-[20px] top-[503px] w-[449px]">{`Teachera Teaching Method ile tasarlanan İş İngilizcesi programlarımız; İŞ İNGİLİZCESİNE GİRİŞ, SATIŞ & PAZARLAMA – YÖNETİM, ve FİNANS & ENDÜSTRİ başlıklarında sunulmaktadır.`}</p>
        <p className="absolute font-['Neutraface_2_Text:Bold',sans-serif] leading-[40px] left-[calc(20.83%-150px)] text-[32px] top-[353px] w-[390px]">KARİYERİN İÇİN İNGİLİZCE: İŞ DÜNYASINA ÖZEL EĞİTİM</p>
      </div>
...
21:30"
      ...
      <div className="absolute flex h-[653px] items-center justify-center left-[calc(41.67%+60px)] top-[259px] w-[780px]">
        <div className="-scale-y-100 flex-none rotate-180">
          <div className="h-[653px] relative w-[780px]" data-name="Hero Image">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-full left-[-12.71%] max-w-none top-0 w-[125.42%]" src={imgHeroImage} />
            </div>
          </div>
        </div>
      </div>
      <Text text="Çocuklar İçin İngilizce" additionalClassNames="left-[calc(16.67%+39px)]" />
