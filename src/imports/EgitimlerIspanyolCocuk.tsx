...
import svgPaths from "./svg-vghds1pkob";
import imgHeroImage from "figma:asset/d8778f77bff55fe690c204470353d9fb1089440c.webp";
import { imgFooterIconContainer } from "./svg-tnp3u";
...
export default function EgitimlerIspanyolCocuk() {
  return (
    <div className="bg-white relative size-full" data-name="Eğitimler_İSPANYOL_çocuk">
      ...
      <div className="absolute content-stretch flex items-center justify-center left-[calc(16.67%+121px)] py-[6px] top-[110px]" data-name="Language Button">
        <div aria-hidden="true" className="absolute border-b border-black border-solid inset-0 pointer-events-none" />
        <p className="font-['Neutraface_2_Text:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[16px] text-black">İSPANYOLCA</p>
      </div>
      ...
      <div className="absolute font-['Neutraface_2_Text:Book',sans-serif] leading-[24px] left-[calc(20.83%-150px)] not-italic text-[#09090f] text-[16px] top-[531px] w-[449px] whitespace-pre-wrap">
        <p className="mb-0">Çocuklarınız, evin konforunda konuşarak ve eğlenerek öğrenirken, Teachera Teaching Method ile dil becerilerini geliştirir. Anadili İspanyolca olan eğitmenler eşliğinde, %100 İspanyolca eğitimlerle konuşma, okuma, yazma ve dinleme becerileri gelişir.</p>
        <p>
          <br aria-hidden="true" />. Çocuğunuzun seviyesine uygun ders planlarıyla eğitim süreci optimize edilir.
          <br aria-hidden="true" />. Birebir veya grup ders seçeneklerinden çocuğunuza en uygun olanı seçin.
          <br aria-hidden="true" />. Konuşarak ve eğlenerek öğrenmenin en etkili yolunu keşfedin.
        </p>
      </div>
      <p className="absolute font-['Neutraface_2_Text:Demi',sans-serif] leading-[24px] left-[150px] not-italic text-[#09090f] text-[20px] top-[463px] w-[449px] whitespace-pre-wrap">7-12 yaş arasındaki her seviyedeki çocuklar için mükemmel bir İspanyolca eğitimi sunuyoruz.</p>
      ...
      <p className="absolute font-['Neutraface_2_Text:Bold',sans-serif] leading-[40px] left-[calc(20.83%-150px)] not-italic text-[#09090f] text-[32px] top-[353px] w-[449px] whitespace-pre-wrap">KÜÇÜKLER İÇİN CANLI VE ETKİLİ İSPANYOLCA</p>
...
21:30"
      ...
      <div className="absolute content-stretch flex items-center justify-center left-[150px] py-[6px] top-[185px]" data-name="Course Title">
        <div aria-hidden="true" className="absolute border-b border-black border-solid inset-0 pointer-events-none" />
        <p className="font-['Neutraface_2_Text:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#09090f] text-[16px]">Çocuklar İçin İspanyolca</p>
      </div>
