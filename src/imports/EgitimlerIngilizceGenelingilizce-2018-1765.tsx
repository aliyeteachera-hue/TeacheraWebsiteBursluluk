...
import svgPaths from "./svg-0f3st21nah";
import imgHeroImage from "figma:asset/477bc1d3824dbef96e202f350e7a635f2944ed47.webp";
import { imgFooterIconContainer } from "./svg-2w09b";
...
export default function EgitimlerIngilizceGenelingilizce() {
  return (
    <div className="bg-white relative size-full" data-name="Eğitimler_İNGİLİZCE_genelingilizce">
      ...
      <LanguageButtonText text="Çocuklar İçin İngilizce" additionalClassNames="left-[calc(16.67%+40px)]" />
      ...
      <div className="absolute content-stretch flex items-center justify-center left-[150px] py-[6px] top-[185px]" data-name="Language Button">
        <div aria-hidden="true" className="absolute border-[#09090f] border-b border-solid inset-0 pointer-events-none" />
        <p className="font-['Neutraface_2_Text:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#09090f] text-[16px]">Genel İngilizce</p>
      </div>
      ...
      <div className="absolute contents left-[150px] not-italic text-[#09090f] top-[353px]" data-name="Hero Text Container">
        <p className="absolute font-['Neutraface_2_Text:Book',sans-serif] leading-[24px] left-[calc(20.83%-150px)] text-[16px] top-[515px] w-[424px] whitespace-pre-wrap">Teachera Teaching Method ile refleks kazandıran, konuşma odaklı derslerle dili içselleştir. Kendine en uygun ders planını seç, birebir veya grup dersleriyle hemen başla!</p>
        <p className="absolute font-['Neutraface_2_Text:Demi',sans-serif] leading-[32px] left-[150px] text-[20px] top-[463px]">Konuş, dinle, yaz, oku — hepsi %100 İngilizce!</p>
        <p className="absolute font-['Neutraface_2_Text:Bold',sans-serif] leading-[40px] left-[calc(20.83%-150px)] text-[32px] top-[353px] w-[315px] whitespace-pre-wrap">YENİ BİR DİLİ KONUŞARAK ÖĞREN!</p>
      </div>
