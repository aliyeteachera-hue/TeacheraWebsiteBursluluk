...
import svgPaths from "./svg-hfvp9p20r5";
import imgHeroImage from "figma:asset/fcb51df5825a321832c36815f1179e4b9a400a77.webp";
import { imgFooterIconContainer } from "./svg-cvtms";
...
export default function EgitimlerAlmanca() {
  return (
    <div className="bg-white relative size-full" data-name="Eğitimler_Almanca">
      ...
      <div className="absolute content-stretch flex items-center justify-center left-[calc(66.67%+70px)] py-[6px] top-[110px]" data-name="Language Button">
        <div aria-hidden="true" className="absolute border-b border-black border-solid inset-0 pointer-events-none" />
        <p className="font-['Neutraface_2_Text:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[16px] text-black">ALMANCA</p>
      </div>
      ...
      <div className="absolute font-['Neutraface_2_Text:Book',sans-serif] leading-[24px] left-[calc(20.83%-150px)] not-italic text-[#09090f] text-[16px] top-[521px] w-[449px] whitespace-pre-wrap">
        <p className="mb-0">%100 Almanca eğitimler, GOETHE - TELC sınav formatlarına uygun, optimize edilmiş ders planları ile Teachera Teaching Method sayesinde yeni bir dili konuşmanın keyfini çıkarın.</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">. %100 Almanca eğitimlerle konuşma, okuma, yazma ve dinleme becerilerini geliştir</p>
        <p className="mb-0">. Özel Teachera Teaching Method ile öğrenmenin keyfini çıkar</p>
        <p className="mb-0">. GOETHE ve TELC sınavlarına hazırlık için destek sağlar</p>
        <p className="mb-0">. Seviyene uygun ders planları ile hedeflerine ulaş</p>
        <p className="mb-0">. Birebir ve grup seçenekleri arasından sana en uygun olanı seç</p>
        <p>. Konuşarak öğrenme fırsatı ile dil öğrenmenin en etkili yolunu keşfet</p>
      </div>
      <p className="absolute font-['Neutraface_2_Text:Demi',sans-serif] leading-[24px] left-[150px] not-italic text-[#09090f] text-[20px] top-[463px] w-[449px] whitespace-pre-wrap">Tüm seviyeler için Almanca dil becerilerinizi geliştirir.</p>
      ...
      <p className="absolute font-['Neutraface_2_Text:Bold',sans-serif] leading-[40px] left-[calc(20.83%-150px)] not-italic text-[#09090f] text-[32px] top-[353px] w-[341px] whitespace-pre-wrap">ALMANCA İLE HEDEFİNE ULAŞ</p>
