...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: 'bursluluk/giris',
        lazy: lazyComponent(() => import('./components/bursluluk/BurslulukCandidateLoginPage')),
      },
      {
        path: 'bursluluk/onay',
        lazy: lazyComponent(() => import('./components/bursluluk/BurslulukApprovalPage')),
      },
      {
        path: 'bursluluk/bekleme',
        lazy: lazyComponent(() => import('./components/bursluluk/BurslulukWaitingPage')),
      },
      {
        path: 'bursluluk/sinav',
        lazy: lazyComponent(() => import('./components/bursluluk/BurslulukExamPage')),
      },
      { path: 'bursluluk/sınav', loader: () => redirect('/bursluluk/sinav') },
      {
        path: 'bursluluk/sonuc',
        lazy: lazyComponent(() => import('./components/bursluluk/BurslulukResultPage')),
      },
