...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'bursluluk/giris', loader: () => redirect('/bursluluk-2026') },
      { path: 'bursluluk/onay', loader: () => redirect('/seviye-tespit-sinavi?stage=onay') },
      { path: 'bursluluk/bekleme', loader: () => redirect('/seviye-tespit-sinavi?stage=bekleme') },
      { path: 'bursluluk/sinav', loader: () => redirect('/seviye-tespit-sinavi?stage=sinav') },
      { path: 'bursluluk/sınav', loader: () => redirect('/seviye-tespit-sinavi?stage=sinav') },
      { path: 'bursluluk/sonuc', loader: () => redirect('/seviye-tespit-sinavi?stage=sonuc') },
      { path: 'bursluluk/sonuç', loader: () => redirect('/seviye-tespit-sinavi?stage=sonuc') },
