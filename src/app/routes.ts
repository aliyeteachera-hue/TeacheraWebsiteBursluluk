...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'bursluluk-2026', lazy: lazyComponent(() => import('./components/bursluluk/BurslulukLandingPage')) },
      { path: 'bursluluk/onay', lazy: lazyComponent(() => import('./components/bursluluk/BurslulukConfirmationPage')) },
      { path: 'bursluluk/giris', lazy: lazyComponent(() => import('./components/bursluluk/BurslulukLoginPage')) },
      { path: 'bursluluk/bekleme', lazy: lazyComponent(() => import('./components/bursluluk/BurslulukWaitingRoomPage')) },
      { path: 'bursluluk/sinav', lazy: lazyComponent(() => import('./components/bursluluk/BurslulukExamPage')) },
      { path: 'bursluluk/sonuc', lazy: lazyComponent(() => import('./components/bursluluk/BurslulukResultPage')) },
      { path: 'panel', loader: () => redirect('/panel/dashboard') },
      { path: 'panel/:section', lazy: lazyComponent(() => import('./components/panel/AdminPanelPage')) },
