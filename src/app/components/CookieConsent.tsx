...
export default function CookieConsent() {
  ...
  const handleAcceptAll = () => {
    ...
    setPreferences(all);
    saveConsent(all, 'accept_all');
  };

  const handleAcceptSelected = () => {
    saveConsent(preferences, 'accept_selected');
  };

  const handleRejectOptional = () => {
    setPreferences(rejectPreferences);
    saveConsent(rejectPreferences, 'reject_optional');
  };
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <OverlayDrawer
          open={isVisible}
          onClose={handleRejectOptional}
          owner="cookie-consent"
          ariaLabel="Çerez tercihleri"
          closeOnEscape={false}
          closeOnOutsideClick={false}
          restoreFocus={false}
          containerClassName="fixed inset-0 z-[999] pointer-events-none"
        >
          {({ panelProps }) => (
            <>
              ...
              {showDetails && (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="fixed inset-0 z-[998] bg-black/45 pointer-events-auto lg:hidden"
              ...
              <motion.div
                ...
                className="fixed bottom-0 left-0 right-0 z-[999] px-3 pb-3 md:px-6 md:pb-6 pointer-events-auto"
              >
                <div className="max-w-[1440px] mx-auto">
                  <div
                    {...panelProps}
                    className="relative bg-[#00000B]/95 backdrop-blur-xl border border-[#324D47]/20 rounded-2xl shadow-[0_-8px_40px_rgba(0,0,0,0.4)] overflow-hidden"
                  >
                    {/* Subtle top accent */}
                            ...
                            <div className="pt-5 mt-5">
                              ...
                              <div className="flex items-center gap-2 mb-5 px-1">
                                ...
                                <p className="text-[11px] text-white/30 font-['Neutraface_2_Text:Book',sans-serif]">
                                  ...
                                  <a href="/hukuki/cerez-politikasi" className="text-[#324D47] hover:underline">
                                    Çerez Politikası
                                  </a>
                                </p>
                              </div>
