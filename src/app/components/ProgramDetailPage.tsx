...
function getArabicGrupFlow(): FlowStep[] {
  return [
    { num: '01', tag: 'KONUŞ', tagEn: 'SPEAK', headline: 'Konuşarak Başla!', customIcon: SpeakIcon, accent: '#006C35', glowColor: 'rgba(0,108,53,0.15)', body: 'Her ders konuşma pratiğiyle açılır. Eğitmen yönlendirmesiyle Fasih Arapça\'da cümle kurarsın, duyduğunu hemen uygulamaya dökersin.', detail: 'Konuşma, öğrenmenin motoru.' },
    { num: '02', tag: 'DİNLE', tagEn: 'LISTEN', headline: 'Anlayarak Dinle!', customIcon: ListenIcon, accent: '#324D47', glowColor: 'rgba(50,77,71,0.15)', body: 'Native speaker eğitmenin kullandığı yapıları ve kelimeleri duyar, farklı bağlamlarda anlam çıkarmayı öğrenirsin. Dinleme, konuşmanın beslenme kaynağıdır.', detail: 'Kulak, dilin ilk kapısıdır.' },
    { num: '03', tag: 'OKU', tagEn: 'READ', headline: 'Metinle Buluş!', customIcon: CorrectIcon, accent: '#006C35', glowColor: 'rgba(0,108,53,0.15)', body: 'Harekeli ve harekesiz metinler üzerinde okuma pratiği yaparsın. Akademik, edebi ve günlük metinlerle kelime dağarcığın ve kavrama gücün büyür.', detail: 'Okumak, dili derinleştirir.' },
...
function getArabicOzelFlow(): FlowStep[] {
  return [
    { num: '01', tag: 'ANALİZ', tagEn: 'ANALYZE', headline: 'Hedefinizi Belirle!', customIcon: ListenIcon, accent: '#006C35', glowColor: 'rgba(0,108,53,0.15)', body: 'İlk görüşmede mevcut seviyeniz, hedefiniz ve öğrenme stiliniz detaylı şekilde analiz edilir. Akademik mi, ticari mi, kültürel mi — yol haritanız buna göre çizilir.', detail: 'Her yolculuk bir pusula ile başlar.' },
    { num: '02', tag: 'KONUŞ', tagEn: 'SPEAK', headline: 'Konuşarak İlerle!', customIcon: SpeakIcon, accent: '#E70000', glowColor: 'rgba(231,0,0,0.12)', body: 'Her ders konuşma pratiğiyle ilerler. Fasih Arapça\'da cümle kurarsınız, duyduğunuzu hemen uygulamaya dökersiniz. Birebir ilgi ile hatalar anında düzeltilir.', detail: 'Konuşmak, öğrenmenin en kısa yoludur.' },
    { num: '03', tag: 'GELİŞTİR', tagEn: 'DEVELOP', headline: '4 Beceriyi Entegre Et!', customIcon: CorrectIcon, accent: '#006C35', glowColor: 'rgba(0,108,53,0.15)', body: 'Dinleme, okuma ve yazma becerileri konuşma etrafında örülür. Harekeli metinler, diyalog pratikleri ve yazma çalışmalarıyla dil bütünsel gelişir.', detail: 'Dört beceri bir arada büyür.' },
    { num: '04', tag: 'PEKİŞTİR', tagEn: 'CONSOLIDATE', headline: 'Bilgiyi Kalıcı Kıl!', customIcon: RepeatCustomIcon, accent: '#E70000', glowColor: 'rgba(231,0,0,0.12)', body: 'Düzenli tekrar döngüleri, ilerleme değerlendirmeleri ve hedef odaklı çalışmalarla öğrendikleriniz kalıcı hale gelir.', detail: 'Tekrar ettikçe, dil içselleşir.' },
  ];
}
