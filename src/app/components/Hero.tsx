    ...
    <section id="home" className="relative h-[100svh] overflow-hidden bg-[#00000B]">
      ...
      <div className="relative z-20 h-full flex flex-col items-center justify-center px-4 sm:px-6 pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 md:pb-24">
        ...
        >
          ...
          >
            {/* Top line */}
            <p className="text-[#EEEBF5]/82 text-[15px] sm:text-[15px] md:text-base lg:text-lg mb-2 sm:mb-3 md:mb-4 font-['Neutraface_2_Text:Book',sans-serif]">
          ...
          >
            ...
            <OrbitingArcButton
              ...
              className="group min-h-[44px] px-4 sm:px-5 md:px-6 py-2.5 sm:py-2 md:py-2.5 border border-[#324D47]/60 backdrop-blur-sm text-[#ffffff] rounded-full text-mobile-meta sm:text-sm md:text-sm font-['Neutraface_2_Text:Demi',sans-serif] hover:bg-[#324D47]/20 hover:border-[#324D47] transition-all flex items-center gap-2"
