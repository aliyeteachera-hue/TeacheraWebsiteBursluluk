    ...
    <section id="home" className="relative h-[100svh] overflow-hidden bg-[#00000B]">
      ...
      <div className="relative z-20 h-full flex flex-col items-center justify-center px-4 sm:px-6 pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 md:pb-24">
        ...
        >
          ...
          >
            {/* Top line */}
            <p className="text-[#EEEBF5]/82 text-mobile-meta sm:text-sm md:text-base lg:text-lg mb-2 sm:mb-3 md:mb-4 font-['Neutraface_2_Text:Book',sans-serif]">
            ...
            <div className="flex flex-wrap justify-center gap-1 sm:gap-1.5 md:gap-2 mb-2 sm:mb-3 md:mb-4">
              {['İngilizce', 'İspanyolca', 'Almanca', 'İtalyanca', 'Fransızca', 'Rusça', 'Arapça'].map((lang, i) => (
                <motion.span
                  ...
                  className="inline-flex items-center px-2.5 py-1 sm:px-2.5 sm:py-0.5 md:px-3 md:py-1 rounded-full border border-[#ffffff]/25 bg-[#ffffff]/8 backdrop-blur-sm text-[#ffffff]/82 text-mobile-kicker sm:text-xs md:text-sm font-['Neutraface_2_Text:Book',sans-serif] hover:bg-[#ffffff]/12 hover:border-[#ffffff]/40 hover:text-[#ffffff] transition-all cursor-default"
            ...
            >
              <p className="text-[#EEEBF5]/82 text-mobile-meta sm:text-sm md:text-base lg:text-lg font-['Neutraface_2_Text:Book',sans-serif]">
                dillerini{' '}
          ...
          >
            ...
            <OrbitingArcButton
              ...
              className="group min-h-[44px] px-4 sm:px-5 md:px-6 py-2.5 sm:py-2 md:py-2.5 border border-[#324D47]/60 backdrop-blur-sm text-[#ffffff] rounded-full text-mobile-kicker sm:text-xs md:text-sm font-['Neutraface_2_Text:Demi',sans-serif] hover:bg-[#324D47]/20 hover:border-[#324D47] transition-all flex items-center gap-2"
            ...
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="group min-h-[44px] px-4 sm:px-5 md:px-6 py-2.5 sm:py-2 md:py-2.5 border border-[#ffffff]/40 backdrop-blur-sm text-[#ffffff] rounded-full text-mobile-kicker sm:text-xs md:text-sm font-['Neutraface_2_Text:Book',sans-serif] hover:bg-[#ffffff]/5 hover:border-[#ffffff]/60 transition-all"
