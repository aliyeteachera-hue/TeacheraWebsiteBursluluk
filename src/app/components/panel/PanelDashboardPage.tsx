...
export default function PanelDashboardPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        const meResponse = await fetch('/api/panel/auth/me', {
          method: 'GET',
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <section className={sectionClassName}>
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-[12px]">
                ...
                <a className="rounded-full border border-[#1A273A] bg-[#071021]/82 px-3 py-2 text-white/72 hover:border-[#2D4363]" href="/api/panel/candidates" target="_blank" rel="noreferrer">Aday API</a>
                <a className="rounded-full border border-[#1A273A] bg-[#071021]/82 px-3 py-2 text-white/72 hover:border-[#2D4363]" href="/api/panel/notifications" target="_blank" rel="noreferrer">Bildirim API</a>
                <a className="rounded-full border border-[#1A273A] bg-[#071021]/82 px-3 py-2 text-white/72 hover:border-[#2D4363]" href="/api/panel/dlq" target="_blank" rel="noreferrer">DLQ API</a>
              </div>
            </section>
            ...
            {activeOpsFocus ? (
              <section className={`${sectionClassName} lg:col-span-2`}>
                ...
                <div className="mt-4 flex flex-wrap gap-2 text-[12px]">
                  {activeOpsFocus === 'candidates' ? (
                    <a className="rounded-full border border-[#1A273A] bg-[#071021]/82 px-3 py-2 text-white/72 hover:border-[#2D4363]" href="/api/panel/candidates" target="_blank" rel="noreferrer">Aday verisini aç</a>
                  ) : null}
                  {activeOpsFocus === 'notifications' ? (
                    <a className="rounded-full border border-[#1A273A] bg-[#071021]/82 px-3 py-2 text-white/72 hover:border-[#2D4363]" href="/api/panel/notifications" target="_blank" rel="noreferrer">Bildirim verisini aç</a>
                  ) : null}
                  {activeOpsFocus === 'dlq' ? (
                    <a className="rounded-full border border-[#1A273A] bg-[#071021]/82 px-3 py-2 text-white/72 hover:border-[#2D4363]" href="/api/panel/dlq" target="_blank" rel="noreferrer">DLQ verisini aç</a>
                  ) : null}
                </div>
              </section>
            ) : null}
