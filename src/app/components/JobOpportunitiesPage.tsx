      ...
      <div className="max-w-[920px] mx-auto">
        ...
        <div className="bg-white border border-[#324D47]/15 rounded-3xl p-7 md:p-10">
          ...
          <p className="text-[#09090F]/70 text-[15px] md:text-[17px] leading-relaxed font-['Neutraface_2_Text:Book',sans-serif] mb-8">
            Teachera ekibine katılmak isteyen adaylar için güncel pozisyonları ve başvuru süreçlerini bu sayfada yayınlıyoruz.
            Açık pozisyon listesi kısa süre içinde paylaşılacaktır.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <InfoCard label="Genel Başvuru E-posta" value="data@teachera.com.tr" href="mailto:data@teachera.com.tr?subject=Genel%20Basvuru%20-%20Teachera" icon={<Mail size={14} />} />
