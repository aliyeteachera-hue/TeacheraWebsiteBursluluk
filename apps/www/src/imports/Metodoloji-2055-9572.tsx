...
import svgPaths from "./svg-dm9gqs3v3z";
import imgImage from "figma:asset/5db0a48ea4e57d3dd7ccc6814666cec8876ff478.webp";
import imgImage1 from "figma:asset/ca54e997f7c2e93791b8c24b18f4ad2506c1a135.webp";
import { imgFooterIconContainer } from "./svg-1098u";
  ...
  return (
    <div className={clsx("absolute h-[29px] w-[146px]", additionalClassNames)}>
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 146 29">
        <g clipPath="url(#clip0_2055_9330)" id="teachera_logo">
...
export default function Metodoloji() {
  return (
    <div className="bg-white relative size-full" data-name="METODOLOJİ">
      ...
      <div className="-translate-x-1/2 absolute contents left-[calc(50%+0.5px)] top-[470px]">
      ...
      <p className="-translate-x-1/2 absolute font-['Neutraface_2_Text:Book',sans-serif] leading-[35px] left-[calc(54.17%-48px)] not-italic text-[#09090f] text-[24px] text-center top-[1262px] w-[1062px] whitespace-pre-wrap">
        ...
        <br aria-hidden="true" />
        Derslerin %85'i, öğretmenin önceden verdiği kelime ve dil bilgisine dayalı sorularla yönlendirilir.
        <br aria-hidden="true" />
...
Milli Eğitim Bakanlığına bağlı faaliyet yürüten, online ve yüzyüze eğitim veren bir dil okuludur"
          >
            <p className="absolute left-[calc(8.33%+104px)] top-[4534.42px] w-[990.479px]">{`Teachera, Avrupa standartlarına karşılık gelen bir müfredat kullanarak, ��ngilizce, İspanyolca, Fransızca, Almanca, `}</p>
...
21:30"
      ...
      <div className="-translate-x-1/2 absolute h-[29px] left-1/2 top-[2103px] w-[146px]" data-name="teachera_logo">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 146 29">
          <g clipPath="url(#clip0_2055_9320)" id="teachera_logo">
            <path d={svgPaths.p12ae49c0} fill="var(--fill-0, #E51E25)" id="Vector" />
            <path d={svgPaths.p26b62580} fill="var(--fill-0, #E51E25)" id="Vector_2" />
            <path d={svgPaths.pd939380} fill="var(--fill-0, #E51E25)" id="Vector_3" />
            <path d={svgPaths.p1f653980} fill="var(--fill-0, #E51E25)" id="Vector_4" />
      ...
      <div className="absolute contents inset-[33.31%_34.47%_59.43%_34.44%]" data-name="FAQ Container">
        <div className="absolute inset-[33.31%_34.47%_59.43%_34.44%]" data-name="Group">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 447.693 337.799">
            <g id="Group">
              <path d={svgPaths.p4397700} fill="url(#paint0_linear_2018_846)" fillOpacity="0.3" id="Vector" />
              <path d={svgPaths.p3b7bf50} fill="url(#paint1_linear_2018_846)" fillOpacity="0.3" id="Vector_2" />
              <path d={svgPaths.p22086800} fill="url(#paint2_linear_2018_846)" fillOpacity="0.3" id="Vector_3" />
              <path d={svgPaths.pc078c80} fill="url(#paint3_linear_2018_846)" fillOpacity="0.3" id="Vector_4" />
              <path d={svgPaths.p2c176cc0} fill="url(#paint4_linear_2018_846)" fillOpacity="0.3" id="Vector_5" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_2018_846" x1="178.748" x2="178.748" y1="0" y2="143.673">
                <stop stopColor="#345A51" />
                <stop offset="1" stopColor="#70C0AE" />
              </linearGradient>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_2018_846" x1="223.177" x2="223.177" y1="41.0428" y2="282.636">
                <stop stopColor="#345A51" />
                <stop offset="1" stopColor="#70C0AE" />
              </linearGradient>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_2018_846" x1="92.5105" x2="92.5105" y1="156.135" y2="236.457">
                <stop stopColor="#345A51" />
                <stop offset="1" stopColor="#70C0AE" />
              </linearGradient>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_2018_846" x1="355.486" x2="355.486" y1="81.2366" y2="161.894">
                <stop stopColor="#345A51" />
                <stop offset="1" stopColor="#70C0AE" />
              </linearGradient>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_2018_846" x1="259.983" x2="259.983" y1="179.587" y2="337.799">
                <stop stopColor="#345A51" />
                <stop offset="1" stopColor="#70C0AE" />
              </linearGradient>
            </defs>
