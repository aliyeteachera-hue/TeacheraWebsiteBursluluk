  ...
  const startExam = async () => {
    ...
    try {
      const sessionResponse = await startExamSession({
        ...
        consent: {
          kvkkApproved: lead.kvkkConsent === true,
          contactConsent: lead.contactConsent === true,
          consentVersion: lead.kvkkConsentVersion || 'KVKK_v1_2026-03-13',
          legalTextVersion: lead.kvkkLegalTextVersion || lead.kvkkConsentVersion || 'KVKK_v1_2026-03-13',
          source: lead.source || 'placement_exam_page',
        },
        kvkkConsent: lead.kvkkConsent === true,
        kvkkConsentVersion: lead.kvkkConsentVersion || 'KVKK_v1_2026-03-13',
        kvkkLegalTextVersion: lead.kvkkLegalTextVersion || lead.kvkkConsentVersion || 'KVKK_v1_2026-03-13',
        contactConsent: lead.contactConsent === true,
      });
